...
For the example cluster, the home page URL is <code>https://dex.<CaptainDomain /></code>.

1. **Authorization callback URL**: Set the authorization callback URL for your OAuth app. Add `/callback` to the homepage URL. For the example cluster your authorization callback URL would be <code>https://dex.<CaptainDomain />/callback</code>.
