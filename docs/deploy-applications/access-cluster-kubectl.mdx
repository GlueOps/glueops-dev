...
- [oidc-login](https://github.com/int128/kubelogin#setup) — the kubectl plugin that handles the browser sign-in.
...
1. Your terminal prints a verification URL and a one-time code.
2. Open the URL in your browser, enter the code, and sign in with GitHub.
...
API access is restricted to an IP allowlist. If you're connecting from a new network or VPN and the connection hangs without ever showing a sign-in prompt, ask your Platform Administrator to add your IP address.
