...
- Your cluster information page: <code>https://cluster-info.<CaptainDomain /></code>
...
- `{{ include "app.name" . }}` → the app's directory name (e.g., `hello-world`)
...
You can monitor the deployment status from the ArgoCD dashboard, accessible via your [cluster information page](https://cluster-info.CAPTAIN_DOMAIN).

## 5. Verify

Once deployed, open your browser and visit:

<code>https://hello-world-prod.apps.<CaptainDomain /></code>
...
<code>https://hello-world-prod.apps.<CaptainDomain />/?env=true</code>
