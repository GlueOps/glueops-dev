...
|----------|------|----------|
| IngressRoute | `my-app-api` | <code>my-app-api.apps.<CaptainDomain /></code> |
| IngressRoute | `my-app-web` | <code>my-app-web.apps.<CaptainDomain /></code> |
...
curl https://my-app-api.apps.CAPTAIN_DOMAIN
curl https://my-app-web.apps.CAPTAIN_DOMAIN
```
